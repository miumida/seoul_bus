    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                # 400 에러 방지를 위해 내부값은 00:00:00 형식을 유지 (UI는 hh:mm 노출)
                vol.Optional(CONF_START_TIME, default="00:00:00"): selector.TimeSelector(selector.TimeSelectorConfig(format="hh:mm")),
                vol.Optional(CONF_END_TIME, default="00:00:00"): selector.TimeSelector(selector.TimeSelectorConfig(format="hh:mm")),
    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_START_TIME, default=options.get(CONF_START_TIME, data.get(CONF_START_TIME, "00:00:00"))): selector.TimeSelector(selector.TimeSelectorConfig(format="hh:mm")),
                vol.Required(CONF_END_TIME, default=options.get(CONF_END_TIME, data.get(CONF_END_TIME, "00:00:00"))): selector.TimeSelector(selector.TimeSelectorConfig(format="hh:mm")),
